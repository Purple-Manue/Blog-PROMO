        ...
        <section id="main">
            <div class="jumbotron container">
                <div class="row">
                    <div class="col-12 col-md-4 order-2 order-lg-1">
                        <div class="row animated slideInLeft">
                            ...
                            <div class="stagiaire col-6 col-lg-4">
                                ...
                                <a target="blank" class="portfolio" href="http://raspberrygreg.ddns.net">Voir le portfolio</a>
                            </div>
                            <div class="stagiaire col-6 col-lg-4">
                    ...
                    <div id="target" class="text-center col-12 col-md-4 order-1 order-lg-2">
                        <div class="row animated zoomInDown">
                            <div class="target col-12">
